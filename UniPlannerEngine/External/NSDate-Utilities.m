...
#pragma mark Crate Date

+ (NSDate *)dateByDay:(int)day month:(int)month andYear:(int)year {

    NSDateComponents* dateGenerator = [[NSDateComponents alloc] init];

    [dateGenerator setDay:day];
    [dateGenerator setMonth:month];
    [dateGenerator setYear:year];

    NSDate *date = [CURRENT_CALENDAR dateFromComponents:dateGenerator];
